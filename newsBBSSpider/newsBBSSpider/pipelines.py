...
from newsBBSSpider.items import PostItem, CommentItem, AuthorItem, FansItem
from newsBBSSpider.utils.gen_db_put import gen_start_spider_info, gen_stop_spider_info, gen_author_put, gen_post_put, \
