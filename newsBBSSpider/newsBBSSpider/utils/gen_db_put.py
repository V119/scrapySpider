...
def gen_fans_put(fans_item):
    ...
    column_values.append(TColumnValue(info_fml, 'fans_id', fans_id.encode()))
    column_values.append(TColumnValue(info_fml, 'friends_id', friends_id.encode()))
