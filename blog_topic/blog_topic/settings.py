...
# Scrapy settings for blog_topic project
#
...
SPIDER_MODULES = ['blog_topic.spiders']
NEWSPIDER_MODULE = 'blog_topic.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'blog_topic (+http://www.yourdomain.com)'
...
ITEM_PIPELINES = {
    'blog_topic.pipelines.SaveMysqlPipeline': 300,
    # 'blog_topic.pipelines.ImagePipeline': 200,
